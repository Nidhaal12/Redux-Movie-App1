...
class Addfilm extends React.Component {
  constructor(props) {
    super(props)
    this.state = { newimage: "", newtitle: "", newyellowstars: 0, newyear: ""}
  ...
  Addtostore(e) {
    e.preventDefault();
    this.props.Addmovie({ id: uuidv1(), image: this.state.newimage , title: this.state.newtitle, yellowstars: this.state.newyellowstars , year: this.state.newyear})
  }
